...
if __name__ == "__main__":
    ...
    last_points_x_homo, last_points_y_homo = main(homo=True,
                                                  model_top=model_top,
                                                  model_bottom=model_bottom)

    last_points_x, last_points_y = main(homo=False,
                                        model_top=model_top,
                                        model_bottom=model_bottom)

    np.savez("./ray_tracing_results/data_focus_3d_homo_raytracer_posese_model.npy",
             x=last_points_x_homo, y=last_points_y_homo)
    np.savez("./ray_tracing_results/data_focus_3d_inhomo_raytracer_posese_model.npy",
